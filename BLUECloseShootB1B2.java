...
@Autonomous(name="Compbot: BLUECloseShootB1B2", group="BLUE")
@Disabled
public class BLUECloseShootB1B2 extends LinearOpMode {
    ...
    public void runOpMode() {
        ...
        gyroHold( TURN_SPEED,   0.0, 0.75);    // Holds turn
        gyroDrive(DRIVE_SPEED,  47.0, 0.0);    // Drive backwards to second beacon
        gyroTurn( TURN_SPEED,   -90.0);         // Turns to beacon at -85 degrees
