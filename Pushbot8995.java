...
public class Pushbot8995
{
    ...
    //OpticalDistanceSensor odsSensor;  // Hardware Device
   // public static final double LEFT_IN_SERVO  =  1.0 ;
   // public static final double lEFT_OUT_SERVO    =  0.0 ;
   // public static final double RIGHT_IN_SERVO  =  0.0 ;
   // public static final double RIGHT_OUT_SERVO    =  1.0 ;
    ...
    public void init(HardwareMap ahwMap) {
       ...
       // leftPush = hwMap.servo.get("s1");
       // rightPush = hwMap.servo.get("s2");
